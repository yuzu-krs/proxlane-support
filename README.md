...
Hosted SaaS の公開ドメインは `proxlane.com` を使用します。アプリ本体は `proxlane.com`、HTTP tunnel は `*.t.proxlane.com`、Agent control は `connect.proxlane.com`、TCP endpoint は `jp-1.tcp.proxlane.com` を基本形にします。
